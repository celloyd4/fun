...
public class MainActivity extends AppCompatActivity {
    ...
    private val hybidAppToken = "dde3c298b47648459f8ada4a982fa92d"; //added for interview and because why not
    private HyBidInterstitialAd mInterstitial; //added for interview

    private enum operator {
        ADD, SUB, MUL, DIV, MOD, ROOT, POW, NULL
    }

    //pasted for interview
...
//        handle equals click
        if (mInputValue1TextView.getText().toString().equals("") || mOperatorTextView.getText().toString().equals("") || mInputValue2TextView.getText().toString().equals("")) {
            ...
            // shows the interstitial ad (this is my best guess - crossing my fingers)
